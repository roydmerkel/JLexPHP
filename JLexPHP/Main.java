...
class CEmit
{
  ...
  private void emit_construct
      ...
      throws java.io.IOException
	{
	  ...
	  /* Member Variables */
	  /*
	  m_outstream.println("\tprivate $yy_reader;");
	  m_outstream.println("\tprivate $yy_buffer_index;");
	  m_outstream.println("\tprivate $yy_buffer_read;");
	  m_outstream.println("\tprivate $yy_buffer_start;");
	  m_outstream.println("\tprivate $yy_buffer_end;");
	  m_outstream.println("\tprivate $yy_buffer = array();");
	  */
...
//	      m_outstream.println("\tprivate $yyline;");
	    }
//	  m_outstream.println("\tprivate $yy_at_bol;");
//	  m_outstream.println("\tprivate $yy_lexical_state;");
...
/*
	  ...
	  m_outstream.println("\t\t\tthrow (new Exception(\"Error: Bad input "
				 + "stream initializer.\"));");
	  m_outstream.println("\t\t}");
	  //m_outstream.println("\t\t$this->yy_reader = new java.io.BufferedReader(reader);");
	  m_outstream.println("\t\t$this->yy_reader = $reader;");
	  m_outstream.println("\t}");
	  m_outstream.println();
*/
...
//	  m_outstream.print(" ()");
	...
	m_outstream.print(")");
	  ...
	  if (null != m_spec.m_init_throw_code)
		...
		/*
	  m_outstream.println("\t\t$this->yy_reader = $reader;");
	  m_outstream.println("\t\t$this->yy_buffer = \"\"; //new char[YY_BUFFER_SIZE];");
	  m_outstream.println("\t\t$this->yy_buffer_read = 0;");
	  m_outstream.println("\t\t$this->yy_buffer_index = 0;");
	  m_outstream.println("\t\t$this->yy_buffer_start = 0;");
	  m_outstream.println("\t\t$this->yy_buffer_end = 0;");
	  if (m_spec.m_count_chars)
	    {
	      m_outstream.println("\t\t$this->yychar = 0;");
	    }
	  if (m_spec.m_count_lines)
	    {
	      m_outstream.println("\t\t$this->yyline = 0;");
	    }
	  m_outstream.println("\t\t$this->yy_at_bol = true;");
	  */
  ...
  private void emit_states
      ...
      throws java.io.IOException
	{
	  ...
	  m_outstream.println("\tstatic $yy_state_dtrans = array(");
  ...
  private void emit_helpers
	...
	/* Function: yy_do_eof */
//	m_outstream.println("\tprivate $yy_eof_done = false;");
	...
	/* Function: yybegin */
	/*
	m_outstream.println("\tprivate function yybegin ($state) {");
	m_outstream.println("\t\t$this->yy_lexical_state = state;");
	m_outstream.println("\t}");
	*/
	...
	/* Function: yy_advance */
	/*
	m_outstream.println("\tprivate function yy_advance () {");
...
//	m_outstream.println();
	...
	m_outstream.println("\t\tif ($this->yy_buffer_index < $this->yy_buffer_read) {");
	m_outstream.println("\t\t\treturn $this->yy_buffer[$this->yy_buffer_index++];");
	m_outstream.println("\t\t}");
	m_outstream.println();

	m_outstream.println("\t\tif (0 != $this->yy_buffer_start) {");
	m_outstream.println("\t\t\t$i = $this->yy_buffer_start;");
	m_outstream.println("\t\t\t$j = 0;");
	m_outstream.println("\t\t\twhile ($i < $this->yy_buffer_read) {");
	m_outstream.println("\t\t\t\t$this->yy_buffer[$j] = $this->yy_buffer[$i];");
	m_outstream.println("\t\t\t\t++$i;");
	m_outstream.println("\t\t\t\t++$j;");
	m_outstream.println("\t\t\t}");
	m_outstream.println("\t\t\t$this->yy_buffer_end = $this->yy_buffer_end - $this->yy_buffer_start;");
	m_outstream.println("\t\t\t$this->yy_buffer_start = 0;");
	m_outstream.println("\t\t\t$this->yy_buffer_read = $j;");
	m_outstream.println("\t\t\t$this->yy_buffer_index = $j;");
	m_outstream.println("\t\t\tnext_read = fread($this->yy_readeread(yy_buffer,");
...
*/
  ...
  private void emit_table
	...
	m_outstream.println("\tstatic $yy_acpt = array(");
  ...
  CLexGen 
	...
	m_outstream 
	  = new java.io.PrintWriter(new java.io.BufferedWriter(
		new java.io.FileWriter(filename + ".php")));
	if (null == m_outstream)
	  {
